    ...
    >
      <Headless.Select
        ...
        className={clsx([
          ...
          // Typography
          'text-base/6 text-foreground placeholder:text-muted-foreground sm:text-sm/6 dark:*:text-popover-foreground',
          'border border-input data-hover:border-input/80',
          'bg-transparent dark:bg-input/30 dark:*:bg-popover',
          'focus:outline-hidden',
          'data-invalid:border-destructive data-invalid:data-hover:border-destructive',
          'data-disabled:border-input/50 data-disabled:opacity-100 dark:data-disabled:border-input dark:data-disabled:bg-muted/50',
        ])}
      />
      {!multiple && (
