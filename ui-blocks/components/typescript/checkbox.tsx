...
const base = [
  ...
  'dark:bg-input/30 dark:group-data-checked:bg-(--checkbox-checked-bg)',
  'border border-input group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-input group-data-checked:bg-(--checkbox-checked-border)',
  ...
  'group-data-disabled:border-input/50 group-data-disabled:bg-muted group-data-disabled:[--checkbox-check:var(--color-muted-foreground)]/50 group-data-disabled:before:bg-transparent',
  'dark:group-data-disabled:border-input dark:group-data-disabled:bg-muted/50 dark:group-data-disabled:[--checkbox-check:var(--color-muted-foreground)]/50 dark:group-data-checked:group-data-disabled:after:hidden',
  // Forced colors mode
...
const colors = {
  ...
  'dark/white': [
    '[--checkbox-check:var(--color-primary-foreground)] [--checkbox-checked-bg:var(--color-primary)] [--checkbox-checked-border:var(--color-primary)]/90',
    'dark:[--checkbox-check:var(--color-foreground)] dark:[--checkbox-checked-bg:var(--color-background)] dark:[--checkbox-checked-border:var(--color-border)]',
  ],
  white:
    '[--checkbox-check:var(--color-foreground)] [--checkbox-checked-bg:var(--color-background)] [--checkbox-checked-border:var(--color-border)]',
  ...
  zinc: '[--checkbox-check:var(--color-secondary-foreground)] [--checkbox-checked-bg:var(--color-secondary)] [--checkbox-checked-border:var(--color-border)]/90',
