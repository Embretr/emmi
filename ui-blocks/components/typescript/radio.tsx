...
const base = [
  ...
  'dark:bg-input/30 dark:group-data-checked:bg-(--radio-checked-bg)',
  'border border-input group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-input group-data-checked:bg-(--radio-checked-border)',
  'dark:border-input dark:group-data-checked:border-primary/40 dark:group-data-hover:group-data-checked:border-primary/40 dark:group-data-hover:border-input',
  ...
  'dark:group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-hover:[--radio-indicator:var(--color-muted-foreground)]',
  ...
  'group-data-disabled:border-input/50 group-data-disabled:bg-muted group-data-disabled:[--radio-checked-indicator:var(--color-muted-foreground)]/50 group-data-disabled:before:bg-transparent',
  'dark:group-data-disabled:border-input dark:group-data-disabled:bg-muted/50 dark:group-data-disabled:[--radio-checked-indicator:var(--color-muted-foreground)]/50 dark:group-data-checked:group-data-disabled:after:hidden',
]
...
const colors = {
  ...
  'dark/white': [
    '[--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)]/90 [--radio-checked-indicator:var(--color-primary-foreground)]',
    'dark:[--radio-checked-bg:var(--color-background)] dark:[--radio-checked-border:var(--color-border)] dark:[--radio-checked-indicator:var(--color-foreground)]',
  ],
  white:
    '[--radio-checked-bg:var(--color-background)] [--radio-checked-border:var(--color-border)] [--radio-checked-indicator:var(--color-foreground)]',
  dark: '[--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)]/90 [--radio-checked-indicator:var(--color-primary-foreground)]',
  zinc: '[--radio-checked-indicator:var(--color-secondary-foreground)] [--radio-checked-bg:var(--color-secondary)] [--radio-checked-border:var(--color-border)]/90',
  red: '[--radio-checked-indicator:var(--color-destructive-foreground)] [--radio-checked-bg:var(--color-destructive)] [--radio-checked-border:var(--color-destructive)]/90',
  orange:
  ...
  indigo:
    '[--radio-checked-indicator:var(--color-primary-foreground)] [--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-primary)]/90',
  violet:
