...
const colors = {
  'dark/zinc': [
    '[--switch-bg-ring:var(--color-primary)]/90 [--switch-bg:var(--color-primary)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:var(--color-primary)]/40',
  ...
  'dark/white': [
    '[--switch-bg-ring:var(--color-primary)]/90 [--switch-bg:var(--color-primary)] dark:[--switch-bg-ring:transparent] dark:[--switch-bg:var(--color-background)]',
    '[--switch-ring:var(--color-primary)]/90 [--switch-shadow:var(--color-foreground)]/10 [--switch:var(--color-primary-foreground)] dark:[--switch-ring:transparent] dark:[--switch:var(--color-foreground)]',
  ],
  dark: [
    '[--switch-bg-ring:var(--color-primary)]/90 [--switch-bg:var(--color-primary)] dark:[--switch-bg-ring:var(--color-border)]',
    '[--switch-ring:var(--color-primary)]/90 [--switch-shadow:var(--color-foreground)]/10 [--switch:var(--color-primary-foreground)]',
  ],
  zinc: [
    '[--switch-bg-ring:var(--color-border)]/90 [--switch-bg:var(--color-secondary)] dark:[--switch-bg-ring:transparent]',
    '[--switch-shadow:var(--color-foreground)]/10 [--switch:var(--color-secondary-foreground)] [--switch-ring:var(--color-border)]/90',
  ],
  white: [
    '[--switch-bg-ring:var(--color-border)]/90 [--switch-bg:var(--color-background)] dark:[--switch-bg-ring:transparent]',
  ...
  red: [
    ...
    '[--switch:var(--color-destructive-foreground)] [--switch-ring:var(--color-destructive)]/90 [--switch-shadow:var(--color-destructive)]/20',
  ],
  orange: [
  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Unchecked
        'bg-muted ring-1 ring-border/50 ring-inset dark:bg-input/40 dark:ring-border',
        // Checked
        ...
        'dark:data-hover:ring-border dark:data-hover:data-checked:ring-(--switch-bg-ring)',
        // Disabled
        'data-disabled:bg-muted data-disabled:opacity-50 data-disabled:data-checked:bg-muted data-disabled:data-checked:ring-border/50',
        'dark:data-disabled:bg-input/30 dark:data-disabled:data-checked:bg-input/30 dark:data-disabled:data-checked:ring-border',
    ...
    >
      <span
        ...
        className={clsx(
          ...
          // Disabled
          'group-data-checked:group-data-disabled:bg-background group-data-checked:group-data-disabled:shadow-sm group-data-checked:group-data-disabled:ring-border/50'
        )}
      />
    </Headless.Switch>
  )
